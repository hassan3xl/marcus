...
const AddProductModal: React.FC<AddProductModalProps> = ({
  ...
  return (
    <BaseModal
      ...
      description="Enter product details and track shelf life accurately."
      size="xl"
    >
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4 bg-primary/5 p-6 rounded-3xl border border-primary/10">
            <h4 className="flex items-center gap-2 text-sm font-bold text-primary uppercase tracking-wider mb-2">
              <Clock size={16} /> Shelf Life Tracking (Optional)
            </h4>
            ...
            <div className="space-y-1">
              ...
              <p className="text-[10px] text-muted-foreground ml-1 italic">
                * Used to auto-calculate Expiry Date from Production Date.
              </p>
            </div>
        ...
        <div className="flex gap-3 pt-4 justify-end">
          ...
          >
            {addProductMutation.isPending ? "Adding..." : "Confirm & Save"}
          </Button>
        </div>
      </form>
    </BaseModal>
